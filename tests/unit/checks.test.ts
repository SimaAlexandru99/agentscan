  ...
  test("declared ids and emitted ids are the same set", () => {
    ...
    const withLock = baseFacts({
      ...
      hooks: [
        ...
        {
          name: "nope",
          path: "/tmp/proj/.windsurf/hooks.json",
          event: "nope",
        ...
        {
          name: "PreToolUse",
          path: "/tmp/proj/.cursor/hooks.json",
          event: "PreToolUse",
          source: "cursor-hooks",
        ...
        {
          name: "NotAKiroEvent",
          path: "/tmp/proj/.kiro/hooks/bad.json",
          event: "NotAKiroEvent",
          source: "kiro-hooks",
          sourceProvider: "kiro",
          schemaProfile: "kiro",
        ...
        {
          name: "PreToolUse",
          path: "/tmp/proj/.kiro/hooks/guard.json",
          event: "PreToolUse",
          source: "kiro-hooks",
          sourceProvider: "kiro",
          schemaProfile: "kiro",
          handlerType: "command",
          command: ".kiro/hooks/gone.sh",
          scriptPath: ".kiro/hooks/gone.sh",
          scriptExists: false,
        },
        {
          name: "Stop",
          path: "/tmp/proj/.kiro/hooks/no-cmd.json",
          event: "Stop",
          source: "kiro-hooks",
          sourceProvider: "kiro",
          schemaProfile: "kiro",
        ...
        {
          name: "SessionStart",
          path: "/tmp/proj/.kiro/hooks/no-prompt.json",
          event: "SessionStart",
          source: "kiro-hooks",
          sourceProvider: "kiro",
          schemaProfile: "kiro",
        ...
        {
          name: "PostFileSave",
          path: "/tmp/proj/.kiro/hooks/bad-type.json",
          event: "PostFileSave",
          source: "kiro-hooks",
          sourceProvider: "kiro",
          schemaProfile: "kiro",
        ...
        {
          name: "(file)",
          path: "/tmp/proj/.kiro/hooks/no-version.json",
          event: "(file)",
          source: "kiro-hooks",
          sourceProvider: "kiro",
          schemaProfile: "kiro",
          defect: "invalid-group",
          kiroInvalidGroup: "missing-version",
        },
      ],
      rules: [
        {
