...
/** Verbatim copy of repo `skills/agentscan/SKILL.md` for site discovery. */
export const AGENTSCAN_SKILL_MD = `---
name: agentscan
...
export const AGENTSCAN_SKILL_DIGEST = `sha256:${createHash("sha256")
  .update(AGENTSCAN_SKILL_MD)
  .digest("hex")}`;
